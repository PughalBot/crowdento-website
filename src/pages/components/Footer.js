...
export default function Footer() {
  return (
    <footer class="w-full font-pp text-[#2E2A39] bg-radial from-[#B3C2FF] via-[#D0AFFF] to-[#E8E2F1]">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    <a href="https://ebiv.in/"  class="flex justify-center lg:justify-start">
                  <img src="/weblogo.png" alt="Logo" className="w-2/3" />
               </a>
                    <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Contemporary fashion for the modern individual</p>
                </div>
                
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Quick Links</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="https://store.ebiv.in"  class="text-gray-600 hover:text-gray-900">Visit Store</a></li>
                        <li class="mb-6"><a href="/about"  class=" text-gray-600 hover:text-gray-900">About</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">People</a></li>
                        <li><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Contact</a></li>
                    </ul>
                </div>
                
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Policies</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-900">Terms of Service</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Privacy Policy</a></li>
                        <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Shipping policy</a></li>
                        <li><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Return & Refund Policy</a></li>
                    </ul>
                </div>
            ...
            <div class="py-7 border-t border-gray-200">
                ...
                <h1 className="text-black font-medium">{`© ${new Date().getFullYear()} EBIV. All Rights Reserved.`}</h1>
                    <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        <a href="https://www.x.com/ebiv_in" target="_blank" class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-black">
                        ...
                        <a href="https://www.instagram.com/ebiv.in/" target="_blank" class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-black">
                        ...
                        <a href="https://www.linkedin.com/company/ebiv-clothing" target="_blank" class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-black">
                        ...
                        <a href="javascript:;" target="_blank" class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-black">
