...
const About = () => {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-20 pb-6 p-4 md:pl-10 md:pr-10">
      ...
      <h1 className="font-bs text-5xl pl-4 md:pl-10 text-[#F7FFF7]">Crowdento's Vision</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-20 pb-6 p-4 md:pl-10 md:pr-10">
      ...
      <h1 className="font-bs text-5xl pl-4 md:pl-10 text-[#F7FFF7]">Crowdento's Mission</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-20 pb-6 p-4 md:pl-10 md:pr-10">
